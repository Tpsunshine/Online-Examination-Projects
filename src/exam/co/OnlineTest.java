/*Java Program for Online examination.
 * Author: Thabo Pitso
 * Date: 2022 May 11
 */
...
public class OnlineTest extends JFrame implements ActionListener
{
	...
	void set()
	{
		...
		if (current == 0)
		{
			l.setText("Que1: Which one among these are primitive datatype?");
			jb[0].setText("int");
			jb[1].setText("Float");
		...
		if (current == 1)
		{
			...
			if (current == 3)
			{
				l.setText("Que: String class is defined in which package?");
				jb[0].setText("lang");
				jb[1].setText("Swing");
				jb[2].setText("Applet");
				jb[3].setText("awt");
			...
			if (current == 4) 
			{
				l.setText("Que5: Which institute is best for java cocaching?");
				jb[0].setText("Utek");
				jb[1].setText("Aptech");
				jb[2].setText("SSS IT");
				jb[3].setText("jtek");	
			...
			if (current == 9) 
			{
				l.setText("Que10: Which one among these is not valid component?");
